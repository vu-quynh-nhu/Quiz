...
public class CategoryScreen {
    static JPanel choicePanel, choiceLabelPanel;
    static JLabel choiceLabel, choice1label, choice2label, choice3label, choice4label;
    static ImageIcon quizLogoIcon, gameIcon, questionImageIcon, medalImage;
    ...
    public static void showCategoryScreen(JFrame mainScreenWindow, JPanel quizLogoPanel, JButton startButton) {
        ...
        try {
            Font archivoQuestion = Font
                    .createFont(Font.TRUETYPE_FONT, new File(".//fonts//Archivo-VariableFont_wdth,wght.ttf"))
                    .deriveFont(27f);
            GraphicsEnvironment graphicsEnvironment = GraphicsEnvironment.getLocalGraphicsEnvironment();
            graphicsEnvironment.registerFont(
                    Font.createFont(Font.TRUETYPE_FONT, new File(".//fonts//Archivo-VariableFont_wdth,wght.ttf")));
        ...
        choice1Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CountdownScreen.showCountdownScreen(mainScreenWindow, choiceLabelPanel, choicePanel, fragen);
            }
        });
         ...
         * MAINSCREEN_WIDTH, MAINSCREEN_HEIGHT, Image.SCALE_DEFAULT));
    ...
    public static void fragenInialisieren(int zahl) {
        ...
        essensFragen.add(new Frage("Aus welchem Land stammt dieses Gericht - Shakshuka?", "Italien", "Deutschland",
        ...
        essensFragen.add(new Frage("Welches Obst ist botanisch gesehen ein Gemüse?", "Rhabarber", "Kiwi", "Erdberre",
        ...
        essensFragen.add(new Frage("Was verbirgt sich hinter dem Gericht Kalakukko?", "Japanische Fischsuppe",
                "Sushi mit Thunfisch", "Fisch im Teigmantel", "Fisch in Kohlmantel", ".//res//foodQuestions/japan.png",
                'C'));
        essensFragen.add(new Frage("Haggis gilt als umstrittene Delikatesse in welchem Land?", "Norwegen", "Island",
        ...
        essensFragen.add(new Frage("Welches Lebensmittel wird in Deutschland am vielfältiges hergestellt?", "Käse",
        ...
        harryPotterFragen.add(
                new Frage("Welcher Zug bringt die Schüler nach Hogwarts?", "Deutsche Bahn", "Der Gleis 9 3/4-Express",
                        "Dumbledore Express", "Der Hogwarts-Express", ".//res//harryQuestions/express.jpg", 'D'));
        harryPotterFragen.add(new Frage("Was ist Dobbys Lieblingskleidungsstück?", "Ein Schal", "Eine Socke", "Ein Hut",
        ...
        harryPotterFragen.add(new Frage("Welcher Ort ist auf diesem Bild zu sehen?", "Hogsmeade", "Hogwarts",
                "Das Haus der Weasleys", "Die Winkelgasse", ".//res//harryQuestions/hogwarts.jpg", 'B'));
        harryPotterFragen.add(new Frage("Welcher Charakter ist auf dem Bild zu sehen?", "Argus Filch",
                "Cornelius Fudge", "Rufus Scrimgeour", "Mundungus Fletcher", ".//res//harryQuestions/filch.jpg", 'A'));
        harryPotterFragen.add(new Frage("Wie heißt die Mutter von Draco Malfoy?", "Molly", "Bellatrix", "Narcissa",
        ...
        harryPotterFragen.add(new Frage("Welcher Charakter ist auf dem Bild zu sehen?", "Albus Dumbledore",
                "Rubeus Hagrid", "Severus Snape", "Lord Voldemort", ".//res//harryQuestions/voldemort.jpg", 'D'));
        harryPotterFragen.add(new Frage("Wer ist der beste Freund von Harry Potter?", "Ron Weasley", "Cedric Diggory",
        ...
        geografieFragen.add(new Frage("Welcher Fluss ist der längste in Europa?", "Donau", "Oka", "Wolgau", "Don",
                ".//res//geoQuestions/fluss.jpeg", 'C'));
        geografieFragen.add(new Frage("Wie hoch ist der Mount Everest?", "8.849 m", "8.545 m", "9.243 m", "8.763 m",
        ...
        geografieFragen.add(new Frage("Welches Land hat die meisten aktiven Vulkane?", "Indonesien", "Island", "Japan",
                "USA", ".//res//geoQuestions/vulkan.jpeg", 'C'));
        geografieFragen.add(new Frage("In welchem Land befindet sich das Great Barrier Reef?", "Neuseeland", "USA",
                "Indien", "Australien", ".//res//geoQuestions/riff.jpeg", 'D'));
        geografieFragen.add(new Frage("In welchem Land befindet sich die größte Salzwüste der Welt, Salar de Uyuni?",
                "Peru", "Bolivien", "Argentinien", "Chile", ".//res//geoQuestions/salzwüste.jpeg", 'C'));
        geografieFragen.add(new Frage("In welchem Land befindet sich der Mount Kilimanjaro?", "Kenia", "Tansania",
                "Uganda", " Äthiopien", ".//res//geoQuestions/kilimanjaro.jpeg", 'B'));
        geografieFragen.add(new Frage("Welches Land hat die größte Bevölkerung auf der Welt?", "China", "Indien", "USA",
        ...
        javaFragen.add(
                new Frage("Was ist Java?", "Donau", "Oka", "Wolgau", "Don", ".//res//javaQuestions/test.png", 'C'));
